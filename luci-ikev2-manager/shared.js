...
var ru = {
	...
	'Runtime dependencies removed. Generic tools and ACME were kept.': 'Зависимости удалены. Общие утилиты и ACME оставлены.',
	...
	'Remove the strongSwan, PBR and XFRM packages this app installed? The VPN stops and managed configuration is cleared. Generic tools and ACME are kept.': 'Удалить пакеты strongSwan, PBR и XFRM, установленные приложением? VPN остановится, управляемая конфигурация очистится. Общие утилиты и ACME останутся.',
	'Apply': 'Применить',
	...
	'This installs PBR, strongSwan, dnsmasq-full and XFRM packages. VPN and routing stay disabled until Activation is enabled.': 'Устанавливает PBR, strongSwan, dnsmasq-full и XFRM-пакеты. VPN и маршрутизация останутся выключены до включения активации.',
	...
	'online': 'онлайн',
	'Disabling this client intentionally blocks selected domains. The kill-switch does not fall back to the home WAN.': 'При отключении клиента выбранные домены намеренно блокируются: защита от утечки не переключает их на домашний WAN.',
	'Policy Routing': 'Политика маршрутизации',
	'Build the IPv4 VPN policy from curated services, manual domains and per-device modes.': 'Собирает IPv4 VPN-политику из сервисов, ручных доменов и режимов устройств.',
	...
	'Domains': 'Домены',
	'Devices': 'Устройства',
	'Curated domain groups are cached locally and merged atomically. Broad infrastructure groups may also route unrelated sites.': 'Готовые группы доменов кэшируются локально и объединяются атомарно. Широкие инфраструктурные группы могут затронуть лишние сайты.',
	'One plain domain per line. Manual entries are never overwritten by community updates.': 'По одному домену на строку. Обновление готовых наборов не изменяет ручные записи.',
	...
	'%d service groups + %d manual': 'готовых наборов: %d · ручных доменов: %d',
